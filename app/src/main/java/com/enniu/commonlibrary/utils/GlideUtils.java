...
import com.enniu.commonlibrary.widget.CornerTransform;
...
public class GlideUtils {
    ...
    public static void loadImg(Context context, Object url, ImageView imageView, CornerTransform transform, int placeDrawable) {
        Glide.with(context)
