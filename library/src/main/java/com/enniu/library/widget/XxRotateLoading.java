 ...
 */
public class XxRotateLoading extends View {
    ...
    public XxRotateLoading(Context context) {
        super(context);
        initView(context, null);
    }

    public XxRotateLoading(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public XxRotateLoading(Context context, AttributeSet attrs, int defStyleAttr) {
