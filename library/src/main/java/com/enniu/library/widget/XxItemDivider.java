...
/**
 * package:com.budou.shareplatform.widget
 * author:布兜小爱
...
public class XxItemDivider extends RecyclerView.ItemDecoration {
    private int dividerWith = 1;
    private Paint paint;
    private RecyclerView.LayoutManager layoutManager;

    // 构造方法,可以在这里做一些初始化,比如指定画笔颜色什么的
    public XxItemDivider() {
        initPaint();
    ...
    public XxItemDivider setDividerWith(int dividerWith) {
        this.dividerWith = dividerWith;
        return this;
    }

    public XxItemDivider setDividerColor(int color) {
        initPaint();
