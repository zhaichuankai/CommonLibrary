...
public class XxNestedScrollWebView extends WebView implements NestedScrollingChild {
    ...
    public XxNestedScrollWebView(Context context) {
        super(context);
        init();
    }
 
    public XxNestedScrollWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
 
    public XxNestedScrollWebView(Context context, AttributeSet attrs, int defStyleAttr) {
