 ...
 * @Created:2020-10-23
 */
public class XxClearEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    public XxClearEditText(Context context) {
        this(context, null);
    }

    public XxClearEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public XxClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
